...
% Steps
\node[step, fill=primaryblue!20] (s1) {1. User Input};
\node[step, fill=primaryblue!20, right=of s1] (s2) {2. ChatProvider};
\node[step, fill=secondarygreen!20, right=of s2] (s3) {3. SendMessage\\UseCase};
\node[step, fill=accentorange!20, right=of s3] (s4) {4. ChatRepo};
\node[step, fill=alertred!20, below=0.8cm of s4] (s5) {5. AI Service};
\node[step, fill=accentorange!20, left=of s5] (s6) {6. Save to\\SQLite};
\node[step, fill=secondarygreen!20, left=of s6] (s7) {7. Return\\Response};
\node[step, fill=primaryblue!20, left=of s7] (s8) {8. Update UI};
